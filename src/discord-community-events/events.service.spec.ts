...
describe('EventsService', () => {
  let service: DiscordCommunityEventsManagementService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<DiscordCommunityEventsManagementService>(DiscordCommunityEventsManagementService);
  });
  ...
  describe('stop', () => {
    ...
    it('should throw active event not found', async () => {
      ...
      try {
        await service.stopEvent(getMockPutEventRequestDto());
      } catch (e) {
    ...
    it('should stop community event', async () => {
      ...
      const result = await service.stopEvent(getMockPutEventRequestDto());
