...
describe('EventsController', () => {
  let controller: DiscordCommunityEventsActiveController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [{ provide: DiscordCommunityEventsManagementService, useValue: mockService }],
    }).compile();

    controller = module.get<DiscordCommunityEventsActiveController>(DiscordCommunityEventsActiveController);
  });
